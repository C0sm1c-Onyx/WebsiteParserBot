...
async def cmd_start(message: Message):
    await message.answer(
        '''Привет! 👋\n\nЯ ваш помощник по парсингу сайтов. 📊✨\n\nС помощью меня вы сможете легко извлекать данные с различных веб-страниц. Чтобы начать, просто загрузите ваш Excel файл, и я помогу вам получить нужные данные!\n\nДавайте начнем! 🚀''',
